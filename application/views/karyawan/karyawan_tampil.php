									...
									<table class="table table-hover datatable"  width="100%" cellspacing="0">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<?php echo $karyawan->emp_name ?>
												</td>
												<td>
													<?php echo $karyawan->title ?>
												</td>
												<td>
													<?php echo $karyawan->salary ?>
												</td>
												
												<td>
													<a href="<?php echo base_url('karyawan/ubah/'.$karyawan->id) ?>"
													class="btn btn-sm btn-primary btn-flat"><i class="fa fa-edit"></i> Edit</a>
													<button onclick="deleteConfirm('<?php echo base_url('karyawan/delete/'.$karyawan->id) ?>')"
